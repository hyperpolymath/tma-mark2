...
public class EtmaHandlerJ extends JFrame
{
        ...
        header.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(final MouseEvent e) {
                ...
                if (vc != 11) {
                    ...
                    final int n = JOptionPane.showOptionDialog(EtmaHandlerJ.this, "Quick Select:", "", 1, 3, null, options, options[0]);
    ...
    public void highlight(final JTextArea textComp, final String pattern) {
        try {
            ...
            for (int pos = 0; (pos = text.indexOf(pattern, pos)) >= 0; pos += pattern.length()) {
                // Fixed: Highlighter uses exclusive end index, so don't subtract 1
    ...
    public void spellReplace() {
        ...
        if (!wrongWord.equals("")) {
            ...
            if (suggFlag) {
                ...
                thisOption = JOptionPane.showOptionDialog(this, (Object)radioPanel, "Spelling Report: " + wrongWord, 1, 3, (Icon)null, options, options[0]);
                ...
                if (thisOption == 2) {
                    ...
                    if (!newWord.equals("")) {
                        ...
                        JOptionPane.showMessageDialog(this, "You haven't selected a replacement!");
                    }
                }
                if (thisOption == 1) {
                ...
                if (thisOption == 3) {
                    ...
                    if (!newWord.equals("")) {
                        ...
                        JOptionPane.showMessageDialog(this, "You haven't typed anything!", "", 2);
                    }
                }
            }
    ...
    public void spellHighlight(final String wrongWord) {
        ...
        // Fixed: removed leading space that caused off-by-one highlight
    ...
    public void spellCheckComments() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Spellcheck complete!");
        }
        catch (final Exception anException) {
            System.out.println("Error " + anException);
            JOptionPane.showMessageDialog(this, "Please choose a dictionary, using the Preferences menu!");
        }
    ...
    public void JavaAwtDesktop() {
        try {
            ...
            desktop.setAboutHandler(e -> JOptionPane.showMessageDialog(this, "This is version " + this.thisVersion, "About " + this.getTitle(), 1));
    ...
    public void exportMarksGrid(final JTable marksTable, String marksFile, final int headerNo) {
        ...
        JOptionPane.showMessageDialog(this, "File has been saved to " + aFolderName + "/" + marksFile2 + ".txt\nas a tab-delimited text file.");
    }
    ...
    private void trainingSiteMenuActionPerformed(final ActionEvent evt) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Unable to connect to " + myURI, "Sorry!", 2);
        }
    }
    ...
    private void colorFrame1WindowClosing(final WindowEvent evt) {
        ...
        if (!this.startUp) {
            JOptionPane.showMessageDialog(this, "You may have to relaunch for the colour changes to come into effect.", "", 1);
        }
    ...
    public void setBrowserPreferences() {
        ...
        try {
            if (this.osName.contains("Linux")) {
                this.currentBrowserPreferences = JOptionPane.showInputDialog(this, "Please enter the short (launch) name of your browser (eg 'firefox').");
            }
            else {
    ...
    public void setWpPreferences() {
        ...
        try {
            if (this.osName.contains("Linux")) {
                this.currentWpPath = JOptionPane.showInputDialog(this, "Please enter the short(launch) name of your Word Processor (eg'ooffice')\n or leave blank for System Default");
            ...
            JOptionPane.showMessageDialog(this, "Word processor path set to " + this.currentWpPath);
    ...
    public void backUp() {
        ...
        if (n == 0) {
            try {
                ...
                this.messageWindow.setVisible(false);
                JOptionPane.showMessageDialog(this, "Backup failed", "", 0);
            }
        }
    }
    ...
    private void sendButtonActionPerformed(final ActionEvent evt) {
        ...
        if (testPreferences.equals("")) {
            JOptionPane.showMessageDialog(this, "Please enter details in 'Mail Preferences'");
        }
        else {
            try {
                ...
                JOptionPane.showMessageDialog(this, "Email has NOT been sent! \n" + anException, "", 0);
            }
        }
    }
    ...
    public boolean unZipAlt() {
        ...
        if (path == 1) {
            ...
            try {
                ...
                this.messageWindow.setVisible(false);
                if (!this.foundItZip) {
                    JOptionPane.showMessageDialog(this, zfSize + " files unzipped to " + dir);
                ...
                if (!nullFlag && !this.foundItZip) {
                    JOptionPane.showMessageDialog(this, "This file has not unzipped properly!");
                }
                zipFlag = false;
            }
    ...
    private void missingSubmissionsActionPerformed(final ActionEvent evt) {
        ...
        if (extractName.equals("")) {
            ...
            JOptionPane.showMessageDialog(this, contentPane, "Missing Submissions", 1);
        }
    }
    ...
    private void lateSubmissionActionPerformed(final ActionEvent evt) {
        if (this.lateSubmission.isSelected()) {
            ...
            final int n = JOptionPane.showOptionDialog(this, "Are you sure? This will mean\r that the student gets a zero score.\nYou should explain this on the PT3.", "Late Submission", 1, 3, null, options, options[1]);
            if (n == 0) {
    ...
    private void savePt3MenuItemActionPerformed(final ActionEvent evt) {
        ...
        this.saveDetails();
        JOptionPane.showMessageDialog(this, "PT3 saved!");
    }
    
    public void progNotFound(final String aString) {
        JOptionPane.showMessageDialog(this, "Sorry, the program '" + aString + "' doesn't seem to exist!\nIf you have set it in Preferences, make sure you've set it to the launcher name.", "", 0);
    }
    ...
    private void setCommentBankFileActionPerformed(final ActionEvent evt) {
        ...
        if (n == 0) {
            ...
            JOptionPane.showMessageDialog(this, "Commentbank file is at " + this.createCommentBank());
        }
        if (n == 1) {
            final JFileChooser _fileChooser = new JFileChooser(this.etmasFolder.getText());
    ...
    private void returnsFolderCheckEmpty() {
        ...
        if (oldZipFiles.size() > 0) {
            ...
            if (n == 0) {
                ...
                JOptionPane.showMessageDialog(this, "Files  deleted");
            }
            else {
                JOptionPane.showMessageDialog(this, "Files not deleted");
            }
        }
    }
    ...
    public void checkWeightingsCodes() {
        ...
        if (!coursesOK) {
            JOptionPane.showMessageDialog(this, "The following courses are not in your module list and may be mistyped:\n" + coursesMissing);
        }
    }
        ...
        if (!this.surname.getText().equals("")) {
            ...
            if (n == 0) {
                try {
                    ...
                    JOptionPane.showMessageDialog(this, "PT3 NOT saved!");
                }
                System.exit(0);
            }
            if (n == 2) {
    ...
    private void batchZipActionPerformed(final ActionEvent evt) {
        ...
        if (rowsSelected.length == 0) {
            this.messageWindow.setVisible(false);
            JOptionPane.showMessageDialog(this, "Please select  files to be zipped by ticking the last column!");
        }
        else {
            ...
            if (continueFlag) {
                ...
                if (this.maxFileNameLength > this.maxAcceptFilename) {
                    ...
                    Toolkit.getDefaultToolkit().beep();
                    JOptionPane.showMessageDialog(this, "At least one of your filenames looks too long!\n (" + this.maxFileNameLength + " characters).\n" + longFileNameString, "", 2);
                }
                ...
                if (numberZipped > 0) {
                    if (success1 && success2) {
                        ...
                        JOptionPane.showMessageDialog(this, "Error - files have NOT been zipped!");
                    }
                }
                else {
                    JOptionPane.showMessageDialog(this, "There were no completed TMAs selected to be zipped!\nMake sure a mark is entered for every part of each question \nand that the tutor comment box is not empty.", "Alert", 2);
                }
                deleteDir(tempBase);
            }
        }
    ...
    private void selectDownloadsFolderActionPerformed(final ActionEvent evt) {
        ...
        while (!okFlag) {
            ...
            if (!thisPath.contains(this.etmasFolder.getText())) {
                ...
                JOptionPane.showMessageDialog(this, "It's not a good idea to download directly into your 'etmas' folder!\nPlease choose another location:");
            }
        }
    }
    ...
    public File cleanFileName(final File aFile) {
        ...
        if (!aFile.isDirectory()) {
            ...
            if (opLen > maxLength) {
                ...
                JOptionPane.showMessageDialog(this, "The filename is too long. It has now been truncated\n to keep it within the OU limit.");
            }
        ...
        for (final String aFileName : fileListString) {
            ...
            if (aFileName.contains(this.markedString) && !fileExists && !fileShortName.startsWith("~$") && createFlag && !firstChar.equals(".")) {
                ...
                if (fileToOpen.contains(".fhi")) {
                    JOptionPane.showMessageDialog(this, "This is a system file - it is not a student script! Please try again.", "", 0);
                }
            ...
            if (extension.equals(".fhi")) {
                ...
                if (createFlag) {
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(this, "Error3 " + anException);
                    }
                }
    ...
    public void tmaOpener(final String tmaFiletoOpen) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, anException2);
        }
    }
    ...
    private void collectTmas() {
        ...
        for (String tempDirectory : this.courseDirectoryList) {
            ...
            if (aFile.getPath().contains(this.etmasFolder.getText())) {
                JOptionPane.showMessageDialog(this, "It looks as though your downloaded file is in your etmas folder.\nYou must move it elsewhere before you import it.", "", 0);
                continueFlag = false;
            }
            else if (!aFile.getName().contains("-")) {
                JOptionPane.showMessageDialog(this, "This is not a correctly named module code folder!", "", 0);
                continueFlag = false;
            }
            else {
                ...
                if (this.isMonitorData) {
                    JOptionPane.showMessageDialog(this, "This is a MONITORING Data File, not one for Marking!\nYou probably need to download the monitor filehandler.", "", 0);
                    continueFlag = false;
                }
                if (!continueFlag) {
                    continue;
                ...
                if (!duplicateFlag) {
                    JOptionPane.showMessageDialog(this, "New files and folders for module " + aFile.getName() + " were transferred successfully! \nYou may discard the 'old' module folder which will be in the Trash or on the Desktop.");
                }
                else {
                    ...
                    if (n2 == 0) {
                        JOptionPane.showMessageDialog(this, "Here are the duplicate files: (Press 'return' to continue)\n" + errorList);
                    }
                }
                File xFile = null;
                if (this.osName.equals("Mac OS X")) {
    ...
    public String createCommentBank() {
        ...
        if (tmaNo.equals("")) {
            JOptionPane.showMessageDialog(this, "You must open a student's PT3 for this module first!");
            return "";
        }
    ...
    private void saveFhiString(final String filePath, final String fhiString) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, anException);
        }
        finally {
            try {
                buffer.close();
    ...
    public String loadVersion(final String aURL) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "No update information available - please check on the website.");
            this.latestVersion = "0.0";
        }
        if (!this.latestVersion.equals(this.thisVersion) && !this.latestVersion.equals("0.0")) {
            ...
            JOptionPane.showMessageDialog(this, "You have the latest version of the filehandler (version " + this.thisVersion);
        }
        else {
            JOptionPane.showMessageDialog(this, "Update check hasn't worked.\nDo you have an internet connection?");
        }
    ...
    private File loadPT3(final String aPathname) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "There seems to be a problem reading the PT3 file. " + anException);
        }
    ...
    private void makeTmaTable(final int version) {
        ...
        try {
            ...
            System.out.println("Error1:" + anException);
            JOptionPane.showMessageDialog(this, "Non numerical folder name found in submission number folder: \n" + (studentCrashNumber + 1) + " " + studentCrashName + " " + anException.getMessage());
        }
    }
            ...
            if (colNo == 4 && this.partStarts.contains(rowNo)) {
                ...
                if (emptyCheck) {
                    ...
                    if (thisTotal.equals("")) {
                        ...
                        JOptionPane.showMessageDialog(this, "Score out of range");
                        this.tmaScores.setValueAt("", rowNo, 4);
                    }
                    else {
                    ...
                    JOptionPane.showMessageDialog(this, "If you want to enter the total only,\nplease remove all the part scores for this question.");
                }
            }
        }
        return editOK;
    ...
    private void tooMany(final int actual, final int max) {
        JOptionPane.showMessageDialog(this, "You have marked too many questions! Required: " + max + ";   Marked or Partmarked: " + actual, "", 0);
        ...
        for (int endLine = this.partStarts.get(this.getQuestionNumbers().size()), i = 0; i < endLine; ++i) {
            try {
                ...
                if (score > max || score < 0.0) {
                    Toolkit.getDefaultToolkit().beep();
                    JOptionPane.showMessageDialog(this, "Mark out of range");
    ...
    public File ampersandClean(final File aFile) {
        ...
        if (fileString.contains("&") || fileString.contains(string18) || fileString.contains(this.string02) || fileString.contains(this.string03)) {
            ...
            fileString = fileString.replaceAll("xyzpqt", "&amp;");
            // FIXED: Write to temp file instead of modifying original
            BufferedWriter bufferOut = null;
            try {
                java.io.File tempFile = java.io.File.createTempFile("etma_ampclean_", ".fhi");
                tempFile.deleteOnExit();
                bufferOut = new BufferedWriter(new FileWriter(tempFile));
    ...
    public File tagClean(final File aFile) {
        ...
        if (fileString.contains(this.string02) || fileString.contains(this.string03) || !fileString.equals(fileStringOld)) {
            ...
            BufferedWriter bufferOut = null;
            try {
                java.io.File tempFile = java.io.File.createTempFile("etma_tagclean_", ".fhi");
                tempFile.deleteOnExit();
                bufferOut = new BufferedWriter(new FileWriter(tempFile));
                bufferOut.write(fileString);
                bufferOut.close();
    ...
    public void zipper() {
        ...
        if (this.submission_status.getText().equals("Unmarked")) {
            JOptionPane.showMessageDialog(this, "You haven't finished marking this yet!", "", 2);
        }
        else {
            int n = 0;
            ...
            if (n == 0) {
                ...
                if (continueFlag) {
                    ...
                    if (success1 && success2) {
                        ...
                        this.messageWindow.setVisible(false);
                        JOptionPane.showMessageDialog(this, "Error - files have NOT been zipped!", "", 0);
                    }
                    deleteDir(tempBase);
                }
            }
    ...
    private void setAudioAppActionPerformed(final ActionEvent evt) {
        ...
        try {
            if (this.osName.contains("Linux")) {
                this.currentAudioPath = JOptionPane.showInputDialog(this, "Please enter the short(launch) name of the application you wish the filehandler to use to open mp3s");
            }
            else {
                final Object[] options = { "Default", "Select other" };
                final JFrame frame = null;
            ...
            JOptionPane.showMessageDialog(this, "Mp3 app path set to " + this.currentAudioPath);
    ...
    public void distributeFile() {
        if (this.course_code.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "You must load a PT3 first!");
        }
        else {
            final JFileChooser _fileChooser = new JFileChooser(this.downloadsFolder.getText());
            try {
                ...
                if (distFileName.contains(".fhi") || distFileName.contains(".app") || distFileName.contains(".exe")) {
                    JOptionPane.showMessageDialog(this, "This is either an etma system file or an application - you can't distribute it!");
                }
                else {
                    ...
                    if (n2 != 1) {
                        ...
                        if (n3 != 1) {
                            ...
                            if (!existsFlag) {
                                JOptionPane.showMessageDialog(this, "The file " + distFilePath + " has been distributed to all students.");
                            }
                            else {
                                JOptionPane.showMessageDialog(this, "The file " + distFilePath + " was distributed to students,\nexcept those where you decided not to replace the file.");
                            }
                        }
                    }
                }
    ...
    public void undoDistribution() {
        try {
            ...
            final String distFilePath = this.distFile.getPath();
            if (distFileName.contains(".fhi") || distFileName.contains(".app") || distFileName.contains(".exe")) {
                JOptionPane.showMessageDialog(this, "This is either an etma system file or an application - you can't delete it!");
            }
            else {
                ...
                if (n3 != 1) {
                    ...
                    if (!preserveFlag) {
                        JOptionPane.showMessageDialog(this, "The file " + distFilePath + " has been deleted in all students' folders.");
                    }
                    else {
                        JOptionPane.showMessageDialog(this, "The file " + distFilePath + " was deleted in students' folders,\nexcept those where you decided not to delete the file.");
                    }
                }
            }
        }
            ...
            System.out.println(anException);
            JOptionPane.showMessageDialog(this, "You can only undo a distribution immediately after you've carried it out.\nYou will have to distribute the file again, then immediately undo it.");
        }
    }
    ...
    private void setCommentBankEditorActionPerformed(final ActionEvent evt) {
        ...
        try {
            if (this.osName.contains("Linux")) {
                this.currentEdPath = JOptionPane.showInputDialog(this, "Please enter the short(launch) name of your Text Editor for the comment bank (eg'gedit')");
            }
            else {
                final Object[] options = { "Default", "Select other" };
                final JFrame frame = null;
            ...
            JOptionPane.showMessageDialog(this, "Comment bank editor path set to " + this.currentEdPath);
    ...
    private void autoImportFlag1ActionPerformed(final ActionEvent evt) {
        ...
        if (df.equals("")) {
            JOptionPane.showMessageDialog(this, "Auto import will only work if you set the location of\nyour browser's download folder in the Filehandler preferences\n(second button from the top).");
    ...
    private void WordCountActionPerformed(final ActionEvent evt) {
        ...
        JOptionPane.showMessageDialog(this, "Approximate word count in PT3 = " + wCount + " words.");
    }
    ...
    private void jMenuItemVersionActionPerformed(final ActionEvent evt) {
        JOptionPane.showMessageDialog(this, "This is version " + this.thisVersion, "About " + this.getTitle(), 1);
    }
