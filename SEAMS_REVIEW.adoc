...
# SPDX-License-Identifier: MIT  # <-- SHOULD BE AGPL-3.0-or-later
----
...
|MIT license header in security.ex |🟡 MEDIUM |Update to AGPL-3.0-or-later
...
1. ✓ Update license headers to AGPL-3.0-or-later
