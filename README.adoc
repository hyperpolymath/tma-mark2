...
=== Transport Security (The Plastic Prison)

**TLS 1.3 only.** No downgrade attacks. No legacy ciphers.

[source]
----
TLS Version:    1.3 only (no 1.2, no 1.1, no 1.0)
Ciphers:        TLS_CHACHA20_POLY1305_SHA256
                TLS_AES_256_GCM_SHA384
                TLS_AES_128_GCM_SHA256
Key Exchange:   X448, X25519, secp521r1, secp384r1
Signatures:     Ed448, Ed25519, ECDSA P-521/P-384
HSTS:           max-age=63072000; includeSubDomains; preload
----

=== HTTP Security Headers

Every header cranked to maximum:
...
|Strict nonce-based, no inline scripts, no eval
...
* **Sessions**: Encrypted, HttpOnly, Secure, SameSite=Strict
